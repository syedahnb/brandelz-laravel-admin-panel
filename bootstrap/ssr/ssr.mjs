...
const Ct = ref(0), fr = ref(1), B = ref({}), ue = ref(0), $e = typeof window > "u";
function Js(e, t, r) {
...
function ro(e, t) {
  ...
  if (e.data.splade.lazy)
    return;
  if (e.data.splade.modal && ue.value++, Lr(e.data.splade), Rt(e.data.splade.head), r === B.value.url && (t = true), e.data.splade.modal)
...
const m = {
  ...
  popStack: no,
  currentStack: ue,
  pageVisitId: computed(() => B.value.pageVisitId),
  dynamicVisitId: computed(() => B.value.dynamicVisitId),
  isSsr: $e
};
...
const le = {
  ...
  setup(e) {
    ...
    return m.setOnHead((f) => {
      ...
      unref(m).isSsr ? (openBlock(), createBlock(le, {
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(m).currentStack.value, (h2) => (openBlock(), createBlock(le, {
        key: `modal.${h2}`,
...
`));
  ...
  return h(s, Object.assign({}, o, u), l);
}
function Ti(e) {
...
let nt = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: Object, default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  ...
  return () => {
    ...
    return h(Fragment, [Boolean(p & 4) && h(hr, { as: "button", type: "button", onFocus: l, features: qt.Focusable }), z({ ourProps: c, theirProps: { ...t, ...h$1 }, slot: u, attrs: t, slots: r, name: "FocusTrap" }), Boolean(p & 4) && h(hr, { as: "button", type: "button", onFocus: l, features: qt.Focusable })]);
  };
} }), { features: ji });
...
let Li = defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: t, attrs: r }) {
...
let $t = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Wr = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: $t }, initialFocus: { type: Object, default: null } }, emits: { close: (e) => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  ...
  let o = ref(0), l = Hr(), u = computed(() => e.open === $t && l !== null ? Y(l.value, { [ke.Open]: true, [ke.Closed]: false }) : e.open), c = ref(/* @__PURE__ */ new Set()), p = ref(null), f = ref(null), d = computed(() => Ye(p));
  ...
  let h$1 = computed(() => s.value && u.value ? 0 : 1), g = computed(() => h$1.value === 0), w = computed(() => o.value > 1), T = inject(yr, null) !== null, A = computed(() => w.value ? "parent" : "leaf");
  Wl(p, computed(() => w.value ? g.value : false)), Ql({ type: "Dialog", enabled: computed(() => h$1.value === 0), element: p, onUpdate: (y, S, _) => {
    if (S === "Dialog")
      return Y(y, { [gr.Add]() {
  ...
  let I = Jl({ name: "DialogDescription", slot: computed(() => ({ open: u.value })) }), E = `headlessui-dialog-${Ne()}`, O = ref(null), v = { titleId: O, panelRef: ref(null), dialogState: h$1, setTitleId(y) {
    O.value !== y && (O.value = y);
  }, close() {
    t("close", false);
  } };
  return provide(yr, v), kl(() => {
    var y, S, _;
  ...
  }, computed(() => h$1.value === 0 && !w.value)), qi((a = d.value) == null ? void 0 : a.defaultView, "keydown", (y) => {
    y.defaultPrevented || y.key === Ii.Escape && h$1.value === 0 && (w.value || (y.preventDefault(), y.stopPropagation(), v.close()));
  }), watchEffect((y) => {
    var S;
    if (h$1.value !== 0 || T)
      return;
    ...
    let y = { ...r, ref: p, id: E, role: "dialog", "aria-modal": h$1.value === 0 ? true : void 0, "aria-labelledby": O.value, "aria-describedby": I.value }, { open: S, initialFocus: _, ...x } = e, $ = { open: h$1.value === 0 };
    return h(vr, { force: true }, () => [h(Li, () => h(Kl, { target: p.value }, () => h(vr, { force: false }, () => h(nt, { initialFocus: _, containers: c, features: g.value ? Y(A.value, { parent: nt.features.RestoreFocus, leaf: nt.features.All & ~nt.features.FocusLock }) : nt.features.None }, () => z({ ourProps: y, theirProps: x, slot: $, attrs: r, slots: n, visible: h$1.value === 0, features: Dt.RenderStrategy | Dt.Static, name: "Dialog" }))))), h(hr, { features: qt.Hidden, ref: f })]);
  };
} });
...
defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  ...
  return n({ el: s, $el: s }), onMounted(() => {
    ...
    return h(vr, { force: true }, () => h(Li, () => z({ ourProps: l, theirProps: { ...t, ...o }, slot: { open: i.dialogState.value === 0 }, attrs: t, slots: r, name: "DialogBackdrop" })));
  };
} });
...
let Ni = Dt.RenderStrategy, Je = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  ...
  i({ el: a, $el: a });
  let { show: l, appear: u } = au(), { register: c, unregister: p } = su(), f = { value: true }, d = Ne(), h$1 = { value: false }, g = Mi(() => {
  ...
  function y(S) {
    ...
    !x || !(x instanceof HTMLElement) || _ || (h$1.value = true, l.value && t("beforeEnter"), l.value || t("beforeLeave"), S(l.value ? _n(x, w, T, A, I, ($) => {
      h$1.value = false, $ === br.Finished && t("afterEnter");
    }) : _n(x, E, O, v, I, ($) => {
      h$1.value = false, $ === br.Finished && (Wt(g) || (s.value = "hidden", p(d), t("afterLeave")));
    })));
  }
  return onMounted(() => {
    watch([l], (S, _, x) => {
  ...
  }), provide(Kr, g), Pl(computed(() => Y(s.value, { visible: ke.Open, hidden: ke.Closed }))), () => {
  ...
  return onMounted(() => {
    ...
    return z({ ourProps: { ...p, as: "template" }, theirProps: {}, slot: {}, slots: { ...n, default: () => [h(ou, { onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave"), ...r, ...p, ...c }, n.default)] }, attrs: {}, features: Ni, visible: s.value === "visible", name: "Transition" });
  };
} });
const lu = {
  props: {
...
function _c(e) {
  var t = e.state, r = e.options, n = e.name, i = r.mainAxis, a = i === void 0 ? true : i, s = r.altAxis, o = s === void 0 ? false : s, l = r.boundary, u = r.rootBoundary, c = r.altBoundary, p = r.padding, f = r.tether, d = f === void 0 ? true : f, h2 = r.tetherOffset, g = h2 === void 0 ? 0 : h2, w = tn(t, {
    boundary: l,
    rootBoundary: u,
    padding: p,
    altBoundary: c
...
function Ic(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, i = r.boundary, a = r.rootBoundary, s = r.padding, o = r.flipVariations, l = r.allowedAutoPlacements, u = l === void 0 ? ku : l, c = Xe(n), p = c ? o ? In : In.filter(function(h2) {
    return Xe(h2) === c;
  }) : Xt, f = p.filter(function(h2) {
...
function Cc(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    ...
    }, []), O = t.rects.reference, v = t.rects.popper, y = /* @__PURE__ */ new Map(), S = true, _ = E[0], x = 0; x < E.length; x++) {
    ...
    if (S)
      for (var gt = h2 ? 3 : 1, Yt = function(ge) {
...
function na(e, t, r, n, i, a) {
  ...
  if (u && c)
    return u == t && c == e;
  var p = -1, f = true, d = r & nf ? new Bt() : void 0;
...
function Wf(e, t, r, n, i, a) {
  ...
  if (!(r & Hf)) {
    var d = c && Xn.call(e, "__wrapped__"), h2 = p && Xn.call(t, "__wrapped__");
    if (d || h2) {
      var g = d ? e.value() : e, w = h2 ? t.value() : t;
      return a || (a = new de()), i(g, w, r, n, a);
    }
  }
  return f ? (a || (a = new de()), Df(e, t, r, n, i, a)) : false;
}
